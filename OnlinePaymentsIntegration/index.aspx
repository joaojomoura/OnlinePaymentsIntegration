...
<body>
     <form id="form1" runat="server">
        <div style="width: 1315px">
            <br />
            Valor:<dx:ASPxTextBox ID="AmountTextBox" runat="server" OnTextChanged="AmountTextBox_TextChanged" Width="170px">
            </dx:ASPxTextBox>
            <br />
            <dx:ASPxButton ID="ShowJsonButton" runat="server" OnClick="ShowJsonButton_Click" Text="Mostrar JSON">
            </dx:ASPxButton>
            <br />
            <dx:ASPxRadioButtonList ID="paymentTypeChosen" runat="server" DataSourceID="XmlDataSource1" ValueField="ID" TextField="Name" OnSelectedIndexChanged="paymentTypeChosen_SelectedIndexChanged">
